...
const videoJouneuSlider = () => {
  ...
  const items = document.querySelectorAll(".video-list__iframe");
  ...
  function hideItem(direction1, direction2, direction3, direction4) {
    isEnabled = false;
    checked[currentChecked].classList.remove("selected");
    items[currentItem].classList.add("currentActiveLeft", direction1);

    // items[currentItem + 1].classList.add("currentActiveCenter", direction2);

    // items[currentItem + 2].classList.add("currentActiveRight", direction3);

    // items[currentItem + 3].classList.add("nextActive", direction4);
    // items[currentItem + 4].classList.add("nextActive", direction4);

    items.forEach((item) =>
      item.addEventListener("animationend", function () {
        items[currentItem - 1].classList.remove(
          "currentActiveLeft",
          "active",
          direction1
        );
        ...
        //   direction2
        // );
        // items[currentItem + 1].classList.add("active");
        // items[currentItem + 2].classList.remove(
        //   "currentActiveRight",
        //   direction3
        // );

        // items[currentItem + 2].classList.add("active");
        // items[currentItem + 3].classList.remove("nextActive", direction4);
        // items[currentItem + 3].classList.add("active");
      })
    );
  }

  // function showItem(direction1, direction2, direction3, direction4) {
  ...
  function previousItem(number) {
    hideItem("to-left", "center-to-left", "right-to-center", "from-right");
    chengeCurrentItem(number + 1);
    showItem();
    if (player.paused) {
      return;
  ...
  function nextItem(number) {
    ...
    chengeCurrentItem(number - 1);
    showItem("to-left", "center-to-left", "right-to-center", "from-right");
    if (player.paused) {
      return;
    } else {
      playVideo();
